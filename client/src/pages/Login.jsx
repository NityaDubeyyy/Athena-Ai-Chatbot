...
const Login = () => {
  ...
  return (
    <div className="h-full w-full flex items-center justify-center font-outfit relative" style={{ perspective: "1000px" }}>
      {/* Main Card */}
      <motion.div
        animate={{ rotateY: isFlipped ? 180 : 0 }}
        transition={{ duration: 0.6, type: "spring", stiffness: 260, damping: 20 }}
        className={`relative w-[380px] sm:w-[420px] ${
          isFlipped ? "h-auto min-h-[650px]" : "h-auto min-h-[550px]"
        }`}
        style={{ transformStyle: "preserve-3d" }}
      >
        {/* Front Side - Login */}
        <div 
          className="absolute inset-0 bg-white/10 dark:bg-black/40 backdrop-blur-xl rounded-3xl border border-white/20 dark:border-white/10 p-8 flex flex-col items-center shadow-2xl"
